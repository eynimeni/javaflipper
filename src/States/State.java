...
@ToDo: Arbeitskommentare:
    ...
    - Bei einem Flipper kann man ja eig. jederzeit den Kugel-Abschuss-Mechnismus auslösen und die Hebel (links/rechts) zum Spielen der Kugel betätigen. Aber es passiert halt nichts, wenn man nicht im Playing ist. Weiß nicht, ob sich das auch für das State-Interface dann eignet?
 */
